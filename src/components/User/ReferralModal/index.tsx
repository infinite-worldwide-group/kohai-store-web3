          ...
          <div className="rounded-lg bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/30 p-6">
            ...
            {errorCode ? (
              <div className="rounded-lg bg-red-500/20 border border-red-500/30 p-4 mb-4">
                <p className="text-sm text-red-300">
                  ⚠️ Unable to load referral code. Please refresh the page.
                </p>
              </div>
            ) : null}
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="flex-1 rounded-lg bg-black/30 px-4 py-3 font-mono text-2xl font-bold text-white text-center">
                {loadingCode ? (
                  ...
                  <span className="text-lg text-gray-400">Code not available</span>
                )}
              </div>
              <button
                onClick={handleCopyCode}
                disabled={!referralCode}
                className={`rounded-lg px-4 py-3 text-white font-semibold transition ${
                  referralCode
            ...
            {referralCode ? (
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <button
                  onClick={() => {
                    const url = `${window.location.origin}/auth/referral?ref=${referralCode}`;
              ...
              <div className="mb-4 rounded-lg bg-yellow-500/10 border border-yellow-500/30 p-3">
                <p className="text-sm text-yellow-300 text-center">
                  ⚠️ Your referral code will be generated by the backend. Please contact support if you don't see a code.
                </p>
              </div>
            )}
